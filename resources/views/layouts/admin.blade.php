            ...
            >
                ...
                <nav class="flex-1 space-y-6 overflow-y-auto px-3 py-4">
                    <div>
                        ...
                        <div class="space-y-1">
                            <x-nav-item href="{{ route('admin.dashboard') }}" icon="dashboard" :active="request()->routeIs('admin.dashboard')">
                                Dashboard
                            </x-nav-item>
                        </div>
                    </div>
                    ...
                    <div>
                        <x-nav-section title="Management" />
                        <div class="space-y-1">
                            <x-nav-item href="{{ route('admin.users.index') }}" icon="users" :active="request()->routeIs('admin.users.*')">Users</x-nav-item>
                        </div>
                    </div>
                    ...
                    <div>
                        <x-nav-section title="Compliance" />
                        <div class="space-y-1">
                            <x-nav-item href="#" icon="compliance">KYC Verification</x-nav-item>
                        </div>
                    </div>

                    <div>
                        <x-nav-section title="Support" />
                        <div class="space-y-1">
                            <x-nav-item href="#" icon="support">Customer Service</x-nav-item>
                        </div>
                    </div>
                    ...
                    <div>
                        ...
                        <div class="space-y-1">
                            <x-nav-item href="#" icon="trading">Trading Control</x-nav-item>
                        </div>
                    </div>

                    <div>
                        <x-nav-section title="Settings" />
                        <div class="space-y-1">
